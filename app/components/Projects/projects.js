  ...
  const featuredProjects = [
    {
      ...
      description: "A complete blogging system with authentication, rich text editing, and real-time updates.",
      architecture: "Monolithic architecture with React frontend and Node.js/Express backend. MongoDB for data persistence with Mongoose ODM. JWT-based authentication with refresh token rotation.",
    ...
    },
    {
      ...
      description: "WebSocket-based messaging application with rooms, file sharing, and presence indicators.",
      architecture: "Client-server architecture with WebSocket connections. Redis for session management and pub/sub. PostgreSQL for message persistence with read replicas for scaling.",
      techStack: ["React", "Node.js", "Socket.io", "PostgreSQL", "Redis", "AWS S3"],
      tradeoffs: [
  ...
  return (
    <section className={styles.container} aria-labelledby="projects-heading">
      <header className={styles.header}>
        ...
        <p>
          Deep dives into projects that demonstrate system design, technical decision-making, 
      ...
      <div className={styles.featuredSection}>
        {featuredProjects.map((project) => (
          ...
          >
            ...
            >
              {expandedProject === project.id ? "Hide Details" : "Show Technical Details"}
            </button>
                ...
                <div className={styles.detailSection}>
                  ...
                  <ul className={styles.techStackList} role="list">
                    {project.techStack.map((tech, idx) => (
                      <li key={idx} className={styles.techStackItem}>{tech}</li>
                    ))}
                  </ul>
                </div>
